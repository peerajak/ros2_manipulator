...
int main(int argc, char **argv) {
  ...
  joint_group_positions_arm[0] = -0.10472; // Shoulder Pan
  joint_group_positions_arm[1] = -0.384;   // Shoulder Lift
  joint_group_positions_arm[2] = -0.349;   // Elbow
  joint_group_positions_arm[3] = 5.4977;   // Wrist 1
  joint_group_positions_arm[4] = 4.8;      // Wrist 2
  joint_group_positions_arm[5] = -5.1313;  // Wrist 3
  ...
  double offset_x_multiplier = 1.000, offset_x_adder = -0.0070625;
  double offset_y_multiplier = 1.000, offset_y_adder = -0.0192545;
  geometry_msgs::msg::Pose target_pose1;
  target_pose1.orientation.x = -1.0;
  target_pose1.orientation.y = 0.00;
  target_pose1.orientation.z = 0.00;
  target_pose1.orientation.w = 0.00;
  target_pose1.position.x = 0.5;//0.5070625*offset_x_multiplier + offset_x_adder;
  target_pose1.position.y = 0.13;//0.1492545*offset_y_multiplier + offset_y_adder;
  target_pose1.position.z = 0.224;
